    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if(responseCode ==200){
                ...
                Intent intentSubActivity = new Intent(LocalActivity.this, Error.class);
		...
		URL_home = QuickstartPreferences.local;
...
// builder.setMessage("네트워크 상태가 원활하지 않습니다. 페이지를 이동합니다.");
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (url.startsWith("tel:")) {
                    ...
                    Intent intentSubActivity = new Intent(LocalActivity.this, IntroActivity.class);
                    startActivity(intentSubActivity);
                    finish();
                    return true;
        ...
        mWebView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
                ...
                Toast.makeText(LocalActivity.this, R.string.download_start, Toast.LENGTH_LONG).show();
    ...
    public class myWebChromeClient extends WebChromeClient {
        ...
        {
            popup=true;
            childView = new WebView(LocalActivity.this);
    ...
    public boolean checkNetwokState() {
        ...
        if (mobile.isConnected() || wifi.isConnected() || blte_4g)
            ...
            AlertDialog.Builder dlg = new AlertDialog.Builder(LocalActivity.this);
