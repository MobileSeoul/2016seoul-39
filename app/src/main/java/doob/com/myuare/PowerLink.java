...
public class PowerLink extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			if(responseCode ==200){
				...
				Intent intentSubActivity = new Intent(PowerLink.this, Error.class);
		...
		URL_home = QuickstartPreferences.power;
			...
			public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
				...
				switch (errorCode) {
					...
					case ERROR_UNSUPPORTED_SCHEME:
						...
						AlertDialog.Builder builder = new AlertDialog.Builder(PowerLink.this);
...
// builder.setMessage("네트워크 상태가 원활하지 않습니다. 페이지를 이동합니다.");
			...
			public boolean shouldOverrideUrlLoading(WebView view, String url) {
				...
				if (url.startsWith("tel:")) {
					...
					Intent intentSubActivity = new Intent(PowerLink.this, IntroActivity.class);
					startActivity(intentSubActivity);
					finish();
					return true;
		...
		mWebView.setDownloadListener(new DownloadListener() {
			...
			public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
				...
				Toast.makeText(PowerLink.this, R.string.download_start, Toast.LENGTH_LONG).show();
	...
	private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
		new AlertDialog.Builder(PowerLink.this)
				.setMessage(message)
	...
	private class myWebViewClient extends WebViewClient {
		...
		public boolean shouldOverrideUrlLoading(WebView view, String url) {
			...
			if(url.startsWith(Uh+"/index.php")){   //페이지상태
				pagestate=0;
	...
	public class myWebChromeClient extends WebChromeClient {
		...
		{
			popup=true;
			childView = new WebView(PowerLink.this);
	...
	public boolean checkNetwokState() {
		...
		if (mobile.isConnected() || wifi.isConnected() || blte_4g)
			...
			AlertDialog.Builder dlg = new AlertDialog.Builder(PowerLink.this);
