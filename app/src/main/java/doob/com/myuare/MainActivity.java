    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if(responseCode ==200){
                ...
                Intent intentSubActivity = new Intent(MainActivity.this, Error.class);
...
// builder.setMessage("네트워크 상태가 원활하지 않습니다. 페이지를 이동합니다.");
        ...
        Login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mWebView.loadUrl(URL_home+"/bbs/member_confirm.php?url=register_form.php");
            }
        });
        ...
        Setting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mWebView.loadUrl(URL_home + "/bbs/mypage.php");
