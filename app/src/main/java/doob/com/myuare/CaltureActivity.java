...
public class CaltureActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            String aa ="http://smudeer.com/index.php";
            URL url = new URL(aa);
            ...
            if(responseCode ==200){
                ...
                Intent intentSubActivity = new Intent(CaltureActivity.this, Error.class);
		...
		URL_home = QuickstartPreferences.calture;
        Uh = QuickstartPreferences.URL_home;
        ...
        Refresh.setOnTouchListener(btnTouchListener);
        ...
        mWebView.setScrollBarStyle(WebView.SCROLLBARS_OUTSIDE_OVERLAY); // 스크롤 노출 타입
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                ...
                switch (errorCode) {
                    ...
                    case ERROR_UNSUPPORTED_SCHEME:
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(CaltureActivity.this);
...
// builder.setMessage("네트워크 상태가 원활하지 않습니다. 페이지를 이동합니다.");
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (url.startsWith("tel:")) {
                    ...
                    startActivity(i);
                    return true;
                } else if (url.startsWith("http://smudeer.com/index.php")) {
                    Intent intentSubActivity = new Intent(CaltureActivity.this, IntroActivity.class);
                    startActivity(intentSubActivity);
                    finish();
                    return true;
        ...
        mWebView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
                ...
                Toast.makeText(CaltureActivity.this, R.string.download_start, Toast.LENGTH_LONG).show();
        ...
        Login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mWebView.loadUrl(Uh+"/bbs/member_confirm.php?url=register_form.php");
            }
        });
        ...
        Setting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mWebView.loadUrl(Uh + "/bbs/mypage.php");
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(CaltureActivity.this)
                .setMessage(message)
    ...
    private class myWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if(url.startsWith("http://+"+URL_home+"/index.php")){   //페이지상태
                pagestate=0;
            }else if(url.indexOf("wr_id")==-1 && url.startsWith(Uh +"/bbs/board.php?bo_table")){
                pagestate=1; //목록
                pageCount=0;
            }else if(url.contains("wr_id") || url.contains("write.php")){
                pagestate=2; //페이지상태
    ...
    public class myWebChromeClient extends WebChromeClient {
        ...
        {
            popup=true;
            childView = new WebView(CaltureActivity.this);
    ...
    private void initial_set() {
        ...
        editor.putString("soundonoff","true");
        editor.putString("vibonoff", "true");
        editor.putString("setting", "true-true-false-false-false-true-false");
        editor.putString("setting_board", "none");
        editor.putString("install", "false");
        editor.commit();
    }
    ...
    public boolean checkNetwokState() {
        ...
        if (mobile.isConnected() || wifi.isConnected() || blte_4g)
            ...
            AlertDialog.Builder dlg = new AlertDialog.Builder(CaltureActivity.this);
